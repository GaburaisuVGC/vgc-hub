        ...
        <div>
          ...
          {loggedInUserId && user && loggedInUserId === user._id && (
            <div>
              ...
              <div className="mt-4">
                <h3 className="text-lg font-bold mb-2">Edit Name</h3>
                <input
                  type="text"
                ...
                <div className="mt-4">
  <h3 className="text-lg font-bold mb-2">Edit Color</h3>
  <div
